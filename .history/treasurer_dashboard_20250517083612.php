        ...
        <body class='bg-gray-50 min-h-screen p-8'>
            <div class='max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8'>
                ...
                <div class='text-center mb-8'>
                    ...
                    <div class='mt-2 text-sm text-gray-500'>" . date('F j, Y', strtotime($payment['created_at'])) . "</div>
                </div>
                ...
                <div class='space-y-4 mb-8'>
                    ...
                    <div class='grid grid-cols-2 gap-4'>
                        <div class='p-4 bg-gray-50 rounded-lg'>
                            ...
                            <div class='font-semibold text-gray-800'>" . ucfirst($payment['payment_method']) . "</div>
                        </div>
                        <div class='p-4 bg-gray-50 rounded-lg'>
                ...
                <div class="bg-white rounded-xl shadow-lg hover-scale">
                    ...
                    <div class="p-6">
                        <div class="overflow-x-auto">
                            ...
                            $requiredColumns = ['firstName', 'lastName', 'userType', 'amount', 'payment_method', 'created_at', 'status', 'id', 'receipt_number'];
                            $hasAllColumns = true;
                                    ...
                                    <?php if ($result && $result->num_rows > 0 && $hasAllColumns): ?>
                                        <?php while ($row = $result->fetch_assoc()): ?>
                                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                ...
                                                <td class="px-6 py-4">
                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?= $row['payment_method'] === 'gcash' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' ?>">
