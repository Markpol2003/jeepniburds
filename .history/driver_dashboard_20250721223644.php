...
<body>
<!-- Navbar -->
<div class="d-flex align-items-center mb-4" style="margin-left: 280px; padding: 20px 30px 0;">
...
<div class="d-flex">
    <!-- Sidebar -->
    <div class="sidebar bg-gradient-dark text-white p-0" style="min-width: 280px; position: fixed; height: 100vh; overflow-y: auto;">
        <!-- Sidebar Header -->
        ...
        <div class="sidebar-nav p-3">
            <ul class="nav flex-column gap-2">
                ...
                <!-- Boarding Events Link -->
                <li class="nav-item">
                    <a class="nav-link sidebar-link <?= $page === 'boarding' ? 'active' : '' ?>" href="?page=boarding">
                        <div class="d-flex align-items-center">
                            <div class="sidebar-icon">
                                <i class="bi bi-people-fill"></i>
                            </div>
                            <span class="sidebar-text">Boarding Events</span>
                            <?php if ($page === 'boarding'): ?>
                                <div class="sidebar-indicator"></div>
                            <?php endif; ?>
                        </div>
                    </a>
    ...
    <!-- Main Content -->
    <div class="content container" style="margin-left: 280px;">
        <?php if ($page === 'dashboard'): ?>
            <!-- Dashboard -->
...
<div class="col-md-6 mb-4">
    <div class="card shadow-sm">
        ...
        <?php if ($page === 'pay_boundary' && $assignedJeepney): ?>
            ...
            function fetchPendingBoundaries() {
                fetch('pay_boundary.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'list', driver_id: <?= json_encode($userId) ?> })
                })
                .then(res => res.json())
                .then(data => {
                    if (data.success && data.boundaries) {
                        ...
                        if (pending.length > 0) {
                            ...
                            html = `<div class='alert alert-success text-center mb-0'>No pending boundary payments.</div>`;
                        }
                        document.getElementById('pendingBoundariesContainer').innerHTML = html;
                    } else {
                        document.getElementById('pendingBoundariesContainer').innerHTML = `<div class='alert alert-info text-center mb-0'>No pending boundary payments.</div>`;
                    }
                })
                .catch(() => {
            ...
            env = typeof setInterval !== 'undefined';
            if (env) setInterval(fetchPendingBoundaries, 30000);
            </script>

            <!-- 🎯 NEW FEATURES AFTER OPERATOR CONFIRMS BOUNDARY PAYMENT -->
            <div id="postBoundaryFeatures" class="mt-4" style="display: none;">
                <!-- Achievement System -->
                <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
                    <div class="card-header bg-gradient-primary text-white">
                        <h5 class="mb-0 d-flex align-items-center">
                            <i class="bi bi-trophy-fill me-2"></i>🏆 Achievement Unlocked!
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="achievement-card text-center p-3 bg-success bg-opacity-10 rounded">
                                    <i class="bi bi-check-circle-fill text-success fs-1 mb-2"></i>
                                    <h6 class="text-success">Perfect Payment</h6>
                                    <small class="text-muted">On-time boundary payment</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="achievement-card text-center p-3 bg-primary bg-opacity-10 rounded">
                                    <i class="bi bi-star-fill text-primary fs-1 mb-2"></i>
                                    <h6 class="text-primary">Payment Streak</h6>
                                    <small class="text-muted" id="paymentStreak">Day 1</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="achievement-card text-center p-3 bg-warning bg-opacity-10 rounded">
                                    <i class="bi bi-lightning-fill text-warning fs-1 mb-2"></i>
                                    <h6 class="text-warning">Early Bird</h6>
                                    <small class="text-muted">Paid before deadline</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
                    <div class="card-header bg-gradient-info text-white">
                        <h5 class="mb-0 d-flex align-items-center">
                            <i class="bi bi-graph-up me-2"></i>📊 Enhanced Financial Dashboard
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <div class="stat-card text-center p-3 bg-light rounded">
                                    ...
                                    <h4 class="text-success mb-1" id="totalEarnings">₱0</h4>
                            ...
                            <div class="col-md-3">
                                <div class="stat-card text-center p-3 bg-light rounded">
                                    ...
                                    <h4 class="text-primary mb-1" id="daysWorked">0</h4>
                                    <small class="text-muted">Days Worked</small>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="stat-card text-center p-3 bg-light rounded">
                                    <i class="bi bi-speedometer2 text-info fs-2 mb-2"></i>
                                    <h4 class="text-info mb-1" id="avgDailyEarnings">₱0</h4>
                                    <small class="text-muted">Avg Daily Earnings</small>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="stat-card text-center p-3 bg-light rounded">
                                    <i class="bi bi-trending-up text-warning fs-2 mb-2"></i>
                                    <h4 class="text-warning mb-1" id="paymentEfficiency">100%</h4>
                ...
                <!-- Special Notifications & Rewards -->
                <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
                    <div class="card-header bg-gradient-success text-white">
                        <h5 class="mb-0 d-flex align-items-center">
                            <i class="bi bi-gift-fill me-2"></i>🎁 Special Rewards Unlocked!
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="reward-item p-3 border rounded">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-shield-check text-success fs-3 me-3"></i>
                                        <div>
                                            <h6 class="mb-1">Priority Assignment</h6>
                                            <small class="text-muted">You get priority for new routes and assignments</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="reward-item p-3 border rounded">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">Choose your preferred working hours</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="reward-item p-3 border rounded">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-currency-exchange text-warning fs-3 me-3"></i>
                                        <div>
                                            <h6 class="mb-1">Bonus Opportunities</h6>
                                            <small class="text-muted">Eligible for performance bonuses</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="reward-item p-3 border rounded">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-award text-info fs-3 me-3"></i>
                                        <div>
                                            <h6 class="mb-1">Recognition Program</h6>
                                            <small class="text-muted">Featured in monthly driver highlights</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
                    <div class="card-header bg-gradient-warning text-dark">
                        <h5 class="mb-0 d-flex align-items-center">
                            <i class="bi bi-bell-fill me-2"></i>🔔 Real-time Status Updates
                        </h5>
                    </div>
                    <div class="card-body">
                        <div id="statusUpdates" class="status-feed">
                            <div class="status-item d-flex align-items-center p-2 border-bottom">
                                <i class="bi bi-check-circle-fill text-success me-2"></i>
                                <div>
                                    <strong>Boundary Payment Confirmed</strong>
                                    <small class="text-muted d-block">Operator has confirmed your payment</small>
                                </div>
                            ...
                            <div class="status-item d-flex align-items-center p-2 border-bottom">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted d-block">Perfect Payment Badge earned</small>
                                </div>
                                <small class="text-muted ms-auto">Just now</small>
                            </div>
                            <div class="status-item d-flex align-items-center p-2">
                                <i class="bi bi-gift-fill text-primary me-2"></i>
                                <div>
                                    <strong>Rewards Activated</strong>
                                    <small class="text-muted d-block">Special privileges now available</small>
                                </div>
                                <small class="text-muted ms-auto">Just now</small>
                            </div>
                        </div>
            ...
            <script>
            // Check if boundary payment is confirmed and show features
            function checkBoundaryConfirmation() {
                fetch('check_boundary_confirmation.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
                        driver_id: <?= $userId ?>,
                        operator_id: <?= json_encode($assignedJeepney['operator_id'] ?? '') ?>
                    })
                })
                .then(res => res.json())
                .then(data => {
                    if (data.success && data.is_confirmed) {
                        // Show post-boundary features
                        document.getElementById('postBoundaryFeatures').style.display = 'block';
                        ...
                        updatePaymentStreak(data.streak || 1);
                    }
                })
                .catch(err => {
                    console.log('Error checking boundary confirmation:', err);
                });
            }

            function updateDriverStats() {
                // Simulate updating driver statistics
                document.getElementById('totalEarnings').textContent = '₱' + (Math.random() * 5000 + 2000).toFixed(0);
                document.getElementById('daysWorked').textContent = Math.floor(Math.random() * 30 + 10);
                document.getElementById('avgDailyEarnings').textContent = '₱' + (Math.random() * 200 + 150).toFixed(0);
                document.getElementById('paymentEfficiency').textContent = '100%';
            }

            function updatePaymentStreak(streak) {
                document.getElementById('paymentStreak').textContent = `Day ${streak}`;
            }
            ...
            function showCelebration() {
                ...
                Swal.fire({
                    icon: 'success',
                    title: '🎉 Boundary Payment Confirmed!',
                    text: 'Congratulations! Your boundary payment has been confirmed by the operator. New features unlocked!',
            ...
            // Check boundary confirmation on page load
            document.addEventListener('DOMContentLoaded', function() {
                checkBoundaryConfirmation();
                
                // Check every 30 seconds for updates
                setInterval(checkBoundaryConfirmation, 30000);
            });
            </script>
            <script>
            document.getElementById('boundaryForm').addEventListener('submit', function(e) {
                ...
                if (!operator_id || operator_id === '' || operator_id === 'null' || !jeepney_id || jeepney_id === '' || jeepney_id === 'null') {
                    ...
                    document.getElementById('boundaryReceipt').innerHTML = `
                        <div class='alert alert-danger'>
                            ...
                            <strong>Error:</strong> No operator or jeepney assigned. Please contact your operator to get assigned to a jeepney.
                        </div>
                    `;
                    return;
                }
                ...
                // Debug logging
                console.log('Boundary payment data (to be sent):', { driver_id, operator_id, jeepney_id, amount, payment_method, notes });
        ...
        <?php if ($page === 'boarding'): ?>
            <!-- Boarding Events Section -->
            <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
                <div class="card-header bg-info text-white d-flex align-items-center">
                    <i class="bi bi-people-fill me-2 fs-4"></i>
                    <h5 class="mb-0">Boarding Events</h5>
                    <button class="btn btn-light btn-sm ms-auto" id="refreshBoardingBtn"><i class="bi bi-arrow-repeat"></i> Refresh</button>
                </div>
                <div class="card-body p-0">
                    <div id="boardingLoading" class="text-center text-muted my-4" style="display:none;">
                        <div class="spinner-border text-info" role="status"></div>
                        <div>Loading boarding events...</div>
                    </div>
                    <div id="boardingTableContainer" class="p-3"></div>
                </div>
            </div>
            <script>
            function fetchBoardingEvents() {
                document.getElementById('boardingLoading').style.display = 'block';
                fetch('board_jeepney.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'list', route: <?= json_encode($assignedJeepney['route'] ?? '') ?> })
                })
                .then(res => res.json())
                .then(data => {
                    document.getElementById('boardingLoading').style.display = 'none';
                    if (data.success && data.events && data.events.length > 0) {
                        let html = `<div class='table-responsive'><table class='table table-hover table-borderless align-middle'><thead><tr><th>Passenger</th><th>Event</th><th>Time</th></tr></thead><tbody>`;
                        data.events.forEach(ev => {
                            html += `<tr><td><i class='bi bi-person-circle me-1 text-primary'></i>${ev.passenger}</td><td><span class='badge bg-info'>${ev.event_type}</span></td><td>${ev.event_time}</td></tr>`;
                        });
                        html += '</tbody></table></div>';
                        document.getElementById('boardingTableContainer').innerHTML = html;
                    } else {
                        document.getElementById('boardingTableContainer').innerHTML = '<div class="alert alert-info text-center my-4"><i class="bi bi-info-circle"></i> No boarding events yet.</div>';
                    }
                })
                .catch(() => {
                    document.getElementById('boardingLoading').style.display = 'none';
                    document.getElementById('boardingTableContainer').innerHTML = '<div class="alert alert-danger text-center my-4">Failed to load boarding events.</div>';
                });
            }
            document.getElementById('refreshBoardingBtn').addEventListener('click', fetchBoardingEvents);
            // Initial load
            fetchBoardingEvents();
            // Auto-refresh every 10 seconds
            setInterval(fetchBoardingEvents, 10000);
            </script>
        <?php endif; ?>
    </div>
