...
.sidebar::-webkit-scrollbar-thumb:hover {
    ...
    <div class="content-wrapper" style="margin-left: 280px; width: calc(100% - 280px); height: 100vh; overflow: hidden;">
        <!-- Navbar -->
        <div class="d-flex align-items-center mb-3" style="padding: 15px 20px 0;">
        ...
        <!-- Content Container -->
        <div class="content-container" style="height: calc(100vh - 80px); overflow-y: auto; padding: 0 20px 20px;">
            <div class="content <?= $page === 'dashboard' ? 'dashboard-page' : ($page === 'apply_driver_operator' ? 'announcement-page' : ($page === 'profile' ? 'profile-page' : ($page === 'apply_cooperative' ? 'cooperative-page' : ($page === 'jeepney_status' ? 'jeepney-status-page' : 'dashboard-page')))); ?>">
    <?php if ($page === 'dashboard'): ?>
        <!-- Dashboard -->
