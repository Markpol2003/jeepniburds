    ...
    <div class="card shadow-sm">
        ...
        <?php if ($page === 'pay_boundary' && $assignedJeepney): ?>
            ...
            document.getElementById('boundaryForm').addEventListener('submit', function(e) {
                ...
                // User-friendly check for assignment
                if (!operator_id || operator_id === '' || !jeepney_id || jeepney_id === '') {
                    Swal.fire({
                        icon: 'error',
                        title: 'No Assignment',
                ...
                // Debug logging
                console.log('Boundary payment data:', { driver_id, operator_id, jeepney_id, amount, payment_method });
                ...
                if (!operator_id || operator_id === '') {
                    document.getElementById('boundaryReceipt').innerHTML = `
                        <div class='alert alert-danger'>
                            <i class="bi bi-exclamation-triangle me-2"></i>
                            <strong>Error:</strong> No operator assigned. Please contact the operator to get assigned to a jeepney.
                        </div>
                    `;
                    return;
                }
