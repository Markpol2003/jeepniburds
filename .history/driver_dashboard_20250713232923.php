...
<head>
    ...
    <style>
        ...
        /* Ensure navbar fits perfectly */
        .d-flex.align-items-center.mb-4 {
            margin-bottom: 0 !important;
            padding: 15px 20px 10px 20px;
        }
        
        /* Remove any extra margins from cards */
        .card {
            margin-bottom: 15px;
        }
...
<div class="d-flex">
    ...
    <!-- Main Content -->
    <div class="content container" style="margin-left: 280px; height: 100vh; overflow: hidden;">
        <!-- Navbar -->
        <div class="d-flex align-items-center mb-4" style="margin-left: 280px; padding: 20px 30px 0;">
            <img src="\tebz\img\logo12.png" alt="JeepniGo Logo" style="height: 40px; margin-right: 15px;">
            <h4 class="mb-0 fw-bold"><?= $userType; ?> Dashboard</h4>
        ...
        <!-- Content Container -->
        <div class="container-fluid px-4" style="height: calc(100vh - 100px); overflow-y: auto;">
        <?php if ($page === 'dashboard'): ?>
            <!-- Dashboard -->
