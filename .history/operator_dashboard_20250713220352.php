...
<?php if ($page === 'collect_boundaries'): ?>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <button class="btn btn-warning btn-sm me-2" id="debugBtn">
            ...
            if (data.success && data.boundaries) {
                ...
                if (pendingCount > lastBoundaryCount && lastBoundaryCount > 0) {
                    ...
                    Swal.fire({
                        ...
                        text: `You have ${pendingCount - lastBoundaryCount} new boundary payment(s) to collect.`,
                        toast: true,
                        position: 'top-end',
                        showConfirmButton: false,
                        timer: 3000
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm bg-primary rounded-circle d-flex align-items-center justify-content-center me-2">
                                        <span class="text-white fw-bold">${b.driver.charAt(0)}</span>
                                    </div>
                                    <div>
                                        <h6 class="mb-0">${b.driver}</h6>
                            ...
                            <td>
                                <div class="small">
                                    ...
                                    <div class="text-muted">${new Date(b.paid_at).toLocaleTimeString()}</div>
                                </div>
                            </td>
                            <td>
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            ...
                            text: 'The boundary payment has been marked as collected.',
                            confirmButtonColor: '#198754'
                        }).then(() => {
                            fetchBoundaries();
                            fetchStats();
    ...
    document.getElementById('debugBtn').addEventListener('click', debugBoundaries);
