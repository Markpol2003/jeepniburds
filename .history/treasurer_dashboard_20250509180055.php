                            ...
                            <form action="update_payment_details.php" method="POST" class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Enter your 11-digit GCash number</p>
                                    </div>

                                    <div>
                                        <label for="gcash_name" class="block text-sm font-medium text-gray-700">GCash Account Name</label>
                                    ...
                                    <div>
                                        <label for="office_address" class="block text-sm font-medium text-gray-700">Office Address (for Cash Payments)</label>
                                        <textarea id="office_address" name="office_address" rows="2"
                                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?= htmlspecialchars($details['office_address'] ?? ''); ?></textarea>
                                    </div>
                                </div>
