...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("UPDATE membership_payments SET status = 'Confirmed', receipt_number = ?, payment_date = CURRENT_TIMESTAMP WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'send_receipt') {
    ...
    try {
        ...
        <body>
            <div class='receipt'>
                <div class='header'>
                    <img src='img/logo12.png' alt='JeepniGo Logo' style='height: 60px; margin-bottom: 10px;'>
