...
.sidebar::-webkit-scrollbar-thumb:hover {
    ...
    <!-- Main Content -->
    <div class="content <?= $page === 'dashboard' ? 'dashboard-page' : ($page === 'apply_driver_operator' ? 'announcement-page' : ($page === 'profile' ? 'profile-page' : ($page === 'apply_cooperative' ? 'cooperative-page' : ($page === 'jeepney_status' ? 'jeepney-status-page' : 'dashboard-page')))); ?>" style="margin-left: 280px; width: 100%;">
    <?php if ($page === 'dashboard'): ?>
        <!-- Dashboard -->
