...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action']) && $_GET['action'] === 'view_receipt') {
    ...
    try {
        ...
        // Add content with the new design
        $html = '
        <div style="text-align: center; margin-top: 80px;">
            <h1 style="color: #198754; font-size: 24px; font-weight: bold; margin: 0;">JEEPNIGO</h1>
            <p style="color: #6c757d; margin: 5px 0;">Official Receipt</p>
        </div>

        <div style="margin: 20px 0; border-top: 2px dashed #198754;"></div>
        ...
        <div style="font-size: 16px; margin: 20px 0;">
            ...
            <p><strong>Received From:</strong> ' . htmlspecialchars($payment['firstName'] . ' ' . $payment['lastName']) . '</p>
        ...
        <div style="margin: 30px 0;">
            <table style="width: 100%;">
                <tr>
                    <td style="width: 50%;">
                        <p style="margin: 5px 0; color: #6c757d;">Received By:</p>
                        <p style="border-bottom: 1px dotted #333; width: 200px;">&nbsp;</p>
                        <small style="color: #6c757d;">Treasurer / Cashier</small>
                    </td>
                    <td style="width: 50%; text-align: right;">
                        <p style="margin: 5px 0; color: #6c757d;">Signature:</p>
                        <p style="border-bottom: 1px dotted #333; width: 200px; margin-left: auto;">&nbsp;</p>
                        <small style="color: #6c757d;">Member Signature</small>
                    </td>
                </tr>
            </table>
        </div>
        ...
        header('Content-Disposition: inline; filename="JeepniGo_Receipt_' . $payment['receipt_number'] . '.pdf"');
