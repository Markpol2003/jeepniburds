...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO membership_payments (user_id, amount, method, reference_number, receipt_number, status, firstName, lastName, userType) VALUES (?, ?, ?, ?, ?, 'Pending', ?, ?, ?)");
