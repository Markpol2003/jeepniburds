...
<head>
    ...
    .apply-now-btn { background-image: linear-gradient(135deg, var(--brand-primary), var(--brand-accent)); border: none; color: #fff; letter-spacing: .3px; }
...
<nav class="navbar navbar-inverse visible-xs" style="display: none;">
  <div class="container-fluid" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); margin: 0; padding: 0;">
    <div class="navbar-header" style="padding: 10px 15px; display: flex; justify-content: space-between; align-items: center;">
      <a class="navbar-brand" href="#" style="color: white; font-weight: bold; margin: 0;">JeepniGo</a>
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar" style="background: none; border: 2px solid white; border-radius: 8px; padding: 5px 10px;">
        <span class="icon-bar" style="display: block; width: 22px; height: 2px; background-color: white; margin: 4px 0;"></span>
        <span class="icon-bar" style="display: block; width: 22px; height: 2px; background-color: white; margin: 4px 0;"></span>
        <span class="icon-bar" style="display: block; width: 22px; height: 2px; background-color: white; margin: 4px 0;"></span>                        
      </button>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar" style="background: rgba(0,0,0,0.1);">
      <ul class="nav navbar-nav" style="margin: 0;">
        <li class="<?= $page === 'dashboard' ? 'active' : '' ?>"><a href="?page=dashboard" style="color: white; padding: 12px 20px;">Dashboard</a></li>
        <li class="<?= $page === 'apply_driver_operator' ? 'active' : '' ?>"><a href="?page=apply_driver_operator" style="color: white; padding: 12px 20px;">Announcements</a></li>
        <li class="<?= $page === 'profile' ? 'active' : '' ?>"><a href="?page=profile" style="color: white; padding: 12px 20px;">My Profile</a></li>
        <li class="<?= $page === 'reservations' ? 'active' : '' ?>"><a href="?page=reservations" style="color: white; padding: 12px 20px;">Reserve Seat</a></li>
        <li class="<?= $page === 'apply_cooperative' ? 'active' : '' ?>"><a href="?page=apply_cooperative" style="color: white; padding: 12px 20px;">Apply Cooperative</a></li>
        <li><a href="../logout.php" style="color: #ff6b6b; padding: 12px 20px;">Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<script>
// Bootstrap collapse toggle for mobile navbar
