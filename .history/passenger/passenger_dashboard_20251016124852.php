...
<div class="text-center mt-3">
    <button type="button" 
            ...
            onclick="console.log('🎯 Button 1 clicked directly!'); alert('Button clicked!');">
        Apply Now
    </button>
...
<?php else: ?>
    ...
    <div class="text-center mt-3">
        <button type="button" 
                ...
                data-bs-toggle="modal" 
                data-bs-target="#applyModal"
                onclick="console.log('🎯 Button 2 clicked directly!'); alert('Button clicked!');">
            Apply Now
        </button>
...
<div class="text-center mt-5">
    <button type="button" 
            ...
            data-bs-toggle="modal" 
            data-bs-target="#applyModal"
            onclick="console.log('🎯 Button 3 clicked directly!'); alert('Button clicked!');">
        Apply Now
    </button>
    <div class="small text-muted mt-2">Submit your Driver/Operator application anytime.</div>
...
document.addEventListener('DOMContentLoaded', function() {
    if (typeof bootstrap !== 'undefined') {
        ...
        if (applyModal) {
            console.log('✅ Apply Modal found in DOM');
            
            // Manually wire up all Apply Now buttons
            const applyButtons = document.querySelectorAll('#applyNowBtn1, #applyNowBtn2, #applyNowBtn3');
            console.log('🔘 Found', applyButtons.length, 'Apply Now buttons');
            
            applyButtons.forEach((btn, index) => {
                btn.addEventListener('click', function(e) {
                    console.log(`🎯 Apply Now button ${index + 1} clicked!`);
                    
                    // Force open modal using Bootstrap
                    try {
                        const modalInstance = bootstrap.Modal.getOrCreateInstance(applyModal);
                        modalInstance.show();
