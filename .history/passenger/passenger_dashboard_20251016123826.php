...
<div class="text-center mt-5">
    <button type="button" class="btn apply-now-btn btn-lg shadow-lg px-5 py-3" data-bs-toggle="modal" data-bs-target="#applyModal" onclick="console.log('Button clicked directly!'); document.getElementById('applyModal').style.display='block'; document.getElementById('applyModal').classList.add('show'); document.body.classList.add('modal-open');">
        Apply Now
    </button>
    <div class="small text-muted mt-2">Submit your Driver/Operator application anytime.</div>
