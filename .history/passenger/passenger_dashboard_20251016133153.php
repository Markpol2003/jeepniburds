...
<head>
    ...
    /* Ensure modal and backdrop are above all dashboard layers */
    .modal {
        position: fixed !important;
        z-index: 20000 !important;
        pointer-events: none !important; /* Allow clicks to pass through the modal container */
    }
    ...
    .modal-backdrop {
        ...
        pointer-events: auto !important; /* Backdrop should be clickable to close modal */
    }
    
    /* Ensure modal dialog is above the backdrop and clickable */
    .modal-dialog {
        position: relative !important;
        z-index: 20001 !important;
        pointer-events: auto !important; /* Make dialog clickable */
    ...
    .modal-content {
        ...
        pointer-events: auto !important; /* Ensure content is fully interactive */
    }
    
    /* Make all interactive elements inside modal clickable */
    .modal-content * {
        pointer-events: auto !important;
    }
    ...
    /* Only reduce z-index when modal is open (Bootstrap adds .modal-open to body) */
    ...
    if (typeof bootstrap !== 'undefined') {
        ...
        if (applyModal) {
            applyModal.addEventListener('shown.bs.modal', function (e) {
                ...
                // Set proper z-index stacking
                if (modalBackdrop) modalBackdrop.style.zIndex = '19999';
                if (modalDialog) {
                ...
                console.log('✅ Modal z-index stacking applied');
                console.log('   Backdrop:', modalBackdrop ? '19999' : 'not found');
                console.log('   Dialog:', modalDialog ? '20001' : 'not found');
                console.log('   Content:', modalContent ? '20002' : 'not found');
            });
        }
    } else {
