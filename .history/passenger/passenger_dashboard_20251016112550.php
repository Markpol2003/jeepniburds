...
<body>
<!-- Sidebar -->
<div class="sidebar bg-gradient-dark text-white p-0" id="sidebar" style="min-width: 280px; position: fixed; height: 100vh; overflow-y: auto;">
    <!-- Sidebar Header -->
...
.sidebar-footer .text-muted {
    ...
    @media (max-width: 768px) {
        ...
        /* Mobile sidebar behavior - handled by mobile-responsive.js */
        .sidebar {
...
<?php endif; ?>
    ...
    /* Responsive behavior (mirror driver) */
    @media (max-width: 992px) {
        .content-wrapper { margin-left: 250px !important; width: calc(100% - 250px) !important; }
    ...
    .mobile-menu-btn { display: none; background: #4f46e5; color: white; border: none; border-radius: 6px; padding: 0.5rem 0.75rem; font-size: 1.25rem; position: fixed; top: 10px; left: 10px; z-index: 1001; }
    ...
    @media (max-width: 992px) {
        .content-wrapper {
            ...
            width: 100% !important;
            padding-top: 60px !important; /* Space for mobile menu button */
            position: relative;
            z-index: 1; /* Below sidebar (9999) and overlay (9998) */
        }
        ...
        /* Ensure all content elements stay below sidebar */
        .content, .card, .alert, .dashboard-header, .header-content {
            position: relative;
            z-index: 1 !important;
        }
    ...
    @media (max-width: 768px) {
        .content-wrapper {
            padding-top: 70px !important; /* More space on smaller screens */
        }
