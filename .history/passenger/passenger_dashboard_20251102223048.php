...
<head>
    ...
    /* Fix modal backdrop - don't block modal content */
    .modal-backdrop {
    ...
    /* Ensure modal itself always on top of backdrop */
    .modal {
        position: fixed !important;
        z-index: 1050 !important;
        pointer-events: none !important; /* Let clicks pass through to backdrop for closing */
    }

    /* Make only modal dialog clickable, not the overlay behind it */
    .modal-dialog {
        pointer-events: auto !important;
    ...
    /* Ensure sidebar doesn't interfere when modal is open */
...
<?php endif; ?>
    ...
    <style>
        ...
        /* Fix modal layering - backdrop should be below modal */
        .modal-backdrop {
            z-index: 1040 !important;
        }
        .modal {
