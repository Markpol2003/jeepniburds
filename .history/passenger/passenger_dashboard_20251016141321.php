    ...
    if (typeof bootstrap !== 'undefined') {
        ...
        if (applyModal) {
            applyModal.addEventListener('shown.bs.modal', function (e) {
                ...
                // AGGRESSIVE FIX: Remove all pointer-events blocking
                ...
                // Force all layers to be interactive
                ...
                if (modalBackdrop) {
                    ...
                    console.log('Backdrop computed style:', window.getComputedStyle(modalBackdrop).zIndex);
                }
                ...
                if (modalDialog) {
                    ...
                    console.log('Dialog computed style:', window.getComputedStyle(modalDialog).zIndex);
                }
                ...
                if (modalContent) {
                    ...
                    console.log('Content computed style:', window.getComputedStyle(modalContent).zIndex);
                }
                ...
                console.log('✅ AGGRESSIVE modal fix applied - all elements enabled');
                console.log('   Total elements enabled:', allElements.length);
                
                // Test if we can focus an input
                setTimeout(() => {
                    const firstInput = modalContent?.querySelector('select, input');
                    if (firstInput) {
