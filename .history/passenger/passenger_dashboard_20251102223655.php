...
<?php endif; ?>
    ...
    <!-- Fare Matrix Modal -->
    <div class="modal fade" id="fareModal" tabindex="-1" style="z-index: 1055 !important;">
        <div class="modal-dialog modal-lg" style="z-index: 1056 !important;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (fareModal) {
        fareModal.addEventListener('shown.bs.modal', function () {
            ...
            fareModal.style.zIndex = '1055';
        });
        
        fareModal.addEventListener('hidden.bs.modal', function () {
            console.log('✅ Fare modal hidden');
