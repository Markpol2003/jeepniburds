    ...
    (function(){
       ...
       function drawMap(){
        ...
        function formatEtaTime(etaTimeStr) {
            ...
            try {
                // Parse the datetime string - MySQL returns format like "2024-01-15 14:30:00"
                // Replace space with 'T' for ISO format, or parse directly
                let etaTime;
                if (etaTimeStr.includes('T')) {
                    etaTime = new Date(etaTimeStr);
                } else {
                    // MySQL datetime format: "YYYY-MM-DD HH:MM:SS"
                    etaTime = new Date(etaTimeStr.replace(' ', 'T'));
                }
                
                // Check if date is valid
                if (isNaN(etaTime.getTime())) {
                    console.error('Invalid ETA time:', etaTimeStr);
                    return '';
                }
            ...
            .then(r=>r.json()).then(d=>{
                ...
                if(etaCandidate){
                    ...
                    if(key !== lastEtaKey){
                        ...
                        if(window.Swal){ Swal.fire({icon:'info', title:'Driver ETA', text:`Driver arriving in approximately ${formattedEta}.`}); }
                    }
                }
