...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment'])) {
    ...
    try {
        ...
        $to = $userInfo['email'];
        $subject = "TEBZ Payment Receipt - " . $receiptNumber;
        $message = "
            <html>
            <head>
            ...
            <body>
                ...
                <ul>
                    ...
                    <li><strong>Payment Method:</strong> " . ucfirst($userInfo['method']) . "</li>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'send_receipt') {
    ...
    try {
        ...
        // Get payment details with all necessary fields
        $stmt = $conn->prepare("
        ...
        $paymentDate = $payment['payment_date'] ?? date('Y-m-d H:i:s'); // Default to current date if not set
        ...
        <body>
                ...
                <ul>
                    ...
                    <li><strong>Date:</strong> " . date('F j, Y', strtotime($paymentDate)) . "</li>
                </ul>
                <p>You can view and download your receipt from your dashboard.</p>
                    <p>Thank you for your payment!</p>
                <br>
            ...
            <div class='max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8'>
                ...
                <div class='text-center mb-8'>
                    <div class='flex justify-center mb-4'>
                        <img src='img/logo12.png' alt='TEBZ Logo' class='h-20 w-auto'>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg hover-scale">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500">New payments will appear here when members submit their registration fees.</p>
                        </div>
                        <?php endif; ?>
                        </div>
                    </div>
