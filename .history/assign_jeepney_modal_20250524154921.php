            ...
            <div class="modal-body p-4">
                ...
                <form id="assignJeepneyForm" action="process_assign_jeepney.php" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" name="plate_number" id="plateNumber" class="form-control" placeholder="Plate Number" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" name="body_number" id="bodyNumber" class="form-control" placeholder="Body Number" required>
                                <label>Body Number <span class="text-danger">*</span></label>
                                <div class="invalid-feedback">Please enter a body number</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" name="route" id="route" class="form-control" placeholder="Assigned Route" required>
                                <label>Assigned Route <span class="text-danger">*</span></label>
                                <div class="invalid-feedback">Please enter a route</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
