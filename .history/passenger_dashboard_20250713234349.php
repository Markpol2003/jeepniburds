...
<head>
    ...
    <style>
        ...
        /* Remove any extra margins/padding from page-specific classes */
        .dashboard-page, .announcement-page, .profile-page, .cooperative-page, .jeepney-status-page {
            margin: 0;
            padding: 0;
            height: 100vh;
        }
        ...
        /* Remove any extra spacing from existing styles */
        .dashboard-header, .location-header {
...
.sidebar::-webkit-scrollbar-thumb:hover {
    ...
    <!-- Main Content -->
    <div class="content <?= $page === 'dashboard' ? 'dashboard-page' : ($page === 'apply_driver_operator' ? 'announcement-page' : ($page === 'profile' ? 'profile-page' : ($page === 'apply_cooperative' ? 'cooperative-page' : ($page === 'jeepney_status' ? 'jeepney-status-page' : 'dashboard-page')))); ?>" style="margin-left: 280px; width: 100%; height: 100vh; overflow: hidden;">
        <!-- Content Container -->
