...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'send_receipt') {
    ...
    try {
        ...
        $stmt = $conn->prepare("
            INSERT INTO user_receipts (user_id, payment_id, receipt_number, amount, payment_method, payment_date, status, receipt_sent)
            VALUES (?, ?, ?, ?, ?, ?, 'Confirmed', 1)
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action']) && $_GET['action'] === 'view_receipt') {
    ...
    try {
        ...
        <body class='bg-gray-50 min-h-screen p-8'>
            <div class='watermark'>TEBZ</div>
            <div class='max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8'>
                <!-- Header -->
                <div class='text-center mb-8'>
                    <div class='flex justify-center mb-4'>
                        <img src='img/tebz-logo.png' alt='TEBZ Logo' class='h-20 w-auto'>
                    </div>
                    <h1 class='text-3xl font-bold text-blue-600 mb-2'>TEBZ</h1>
                ...
                <div class='text-center text-sm text-gray-500 mt-8'>
                    <p>Thank you for your payment!</p>
                    <p class='mt-1'>This receipt serves as proof of your payment to TEBZ.</p>
                </div>
