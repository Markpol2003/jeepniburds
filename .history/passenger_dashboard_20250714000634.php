                ...
                <div class="actions-section">
                    <div class="actions-card">
                        <div class="actions-header">
                            <h3>Quick Actions</h3>
                            <div class="actions-indicator">
                                <span class="actions-dot"></span>
                                <span class="actions-text">Available</span>
                            </div>
                        </div>
                        
                        <div class="actions-content">
                            <div class="action-buttons">
                                <a href="?page=jeepney_status" class="action-btn">
                                    <i class="bi bi-geo-alt-fill"></i>
                                    <span>Check Jeepney Status</span>
                                </a>
                                <a href="?page=apply_cooperative" class="action-btn">
                                    <i class="bi bi-building-fill"></i>
                                    <span>Apply for Cooperative</span>
                                </a>
                                <a href="?page=apply_driver_operator" class="action-btn">
                                    <i class="bi bi-megaphone-fill"></i>
