            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        ...
                        html: `<b>Receipt #:</b> ${data.receipt.receipt_number}<br>
                               <b>Route:</b> ${data.receipt.route}<br>
                               <b>Amount:</b> ₱${data.receipt.amount}<br>
                               <b>Method:</b> ${data.receipt.payment_method}<br>
                               <b>Date:</b> ${data.receipt.date}`
                    });
                    fetchJeepneyStatus();
                } else {
                    Swal.fire('Error', data.message || 'Failed to pay fare.', 'error');
                }
            });
        }
    });
    ...
    <div class="container mt-5 d-flex justify-content-center">
      <div class="card shadow-lg p-4" style="max-width: 420px; width: 100%;">
        <div class="text-center mb-4">
          <div class="rounded-circle bg-primary bg-gradient d-inline-flex align-items-center justify-content-center" style="width: 90px; height: 90px;">
            <i class="bi bi-person-circle text-white" style="font-size: 3rem;"></i>
          </div>
          <h3 class="mt-3 mb-0">My Profile</h3>
          <p class="text-muted mb-0" style="font-size: 1rem;">View and update your personal information</p>
        </div>
