    ...
    <div class="content container" style="margin-left: 250px;">
        ...
        <?php elseif ($page === 'collect_fares' && $assignedJeepney): ?>
            ...
            <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(90deg, #1abc9c 0%, #3498db 100%); border-top-left-radius: 1rem; border-top-right-radius: 1rem;">
                    <h5 class="mb-0 text-white d-flex align-items-center">
                        <i class="bi bi-cash-coin me-2 fs-3"></i> Collect Fares
            ...
            function fetchFares() {
                ...
                console.log('Fetching fares for route:', route);
                fetch('pay_fare.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                ...
                .then(data => {
                    ...
                    if (data.success && data.fares.length > 0) {
                        ...
                        let html = `<div class='table-responsive'><table class='table table-hover table-borderless align-middle modern-fare-table'><thead><tr><th>Passenger</th><th>Amount</th><th>Method</th><th>Date</th><th>Receipt</th><th>Status</th><th>Action</th></tr></thead><tbody>`;
                        ...
                        document.getElementById('faresTableContainer').innerHTML = '<div class="alert alert-info text-center my-4"><i class="bi bi-info-circle"></i> No fares collected yet for this route.</div>';
                        lastFareReceipts = [];
                        lastFareCount = 0;
                    }
                })
            ...
            function confirmCollected(receiptNumber, btn) {
                ...
                .then(data => {
                    if (data.success) {
                        btn.closest('tr').querySelector('td:nth-child(6) span').className = 'badge rounded-pill bg-success px-3 py-2 fs-6';
                        ...
                        Swal.fire({
                            ...
                            text: 'Payment has been marked as collected.',
                            showConfirmButton: false,
                            timer: 3000
                        });
                    } else {
