...
if (isset($data['driver_id'], $data['amount'], $data['payment_method'])) {
    try {
        ...
        if ($assignment) {
            ...
            // If no assignment, require operator_id in POST data
            if (!empty($data['operator_id']) && intval($data['operator_id']) > 0) {
                ...
                throw new Exception('No active jeepney assignment found for this driver, and no valid operator_id provided. Please contact your operator.');
            }
        }
