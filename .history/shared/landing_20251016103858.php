            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    ...
                    ">
                        ...
                        <p style="color: #718096; line-height: 1.7;">Know exactly where your jeepney is and when it will arrive with live GPS tracking.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="modern-feature-card animate__animated animate__fadeInUp" style="
                    ...
                    ">
                        ...
                        ">
                            <i class="bi bi-phone-fill" style="font-size: 2rem; color: white;"></i>
                        </div>
                        <h4 class="h4 mb-3 fw-bold" style="color: #1a202c;">Easy Booking</h4>
                        <p style="color: #718096; line-height: 1.7;">Book your rides in advance with just a few taps on your mobile device.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="modern-feature-card animate__animated animate__fadeInUp" style="
                    ...
                    ">
                        ...
                        <h4 class="h4 mb-3 fw-bold" style="color: #1a202c;">Secure Payments</h4>
                        <p style="color: #718096; line-height: 1.7;">Pay safely and conveniently through our secure payment platform.</p>
                    </div>
                </div>
            </div>
        </div>
