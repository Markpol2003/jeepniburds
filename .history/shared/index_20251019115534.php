...
<body>
    ...
    ">
        <div class="container" style="max-width: 1200px; padding: 0 2rem;">
            <a class="navbar-brand d-flex align-items-center" href="#" style="transition: transform 0.3s ease;">
                <img src="../img/logo12.png" alt="JeepniGo Logo" class="navbar-logo" style="width: 45px; height: auto; margin-right: 10px; transition: transform 0.3s ease;">
    ...
    /* Navbar Toggler Icon - Make it white and visible */
    .navbar-toggler {
...
.modern-feature-card:hover .modern-feature-icon {
    ...
    ">
        ...
        <div class="container" style="position: relative; z-index: 10;">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="about-image-section animate__animated animate__fadeInLeft">
                        ...
                        <div style="position: relative; max-width: 500px; margin: 0 auto;">
                            ...
                            ">
                                <div class="text-center mb-4">
                                    ...
                                    ">
                                        <i class="bi bi-bus-front-fill" style="font-size: 2.5rem; color: white;"></i>
                                    </div>
                                    <h4 class="fw-bold mb-2" style="color: #1a202c;">Innovation in Motion</h4>
                                    <p style="color: #718096; font-size: 0.95rem;">Transforming public transportation with cutting-edge technology</p>
                                </div>
                                <div class="row text-center mt-4">
                                    <div class="col-4">
                                        <h3 class="fw-bold mb-0" style="color: #667eea;">2025</h3>
                                        <small style="color: #718096;">Founded</small>
                                    </div>
                                    <div class="col-4">
                                        <h3 class="fw-bold mb-0" style="color: #f093fb;">24/7</h3>
                                        <small style="color: #718096;">Support</small>
                                    </div>
                                    <div class="col-4">
                                        <h3 class="fw-bold mb-0" style="color: #4facfe;">100%</h3>
                                        <small style="color: #718096;">Secure</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content animate__animated animate__fadeInRight">
                        ...
                        <h2 class="display-5 fw-bold text-white mb-4">About JeepniGo</h2>
                        <p class="text-white mb-4" style="font-size: 1.15rem; line-height: 1.8; opacity: 0.95;">
                            JeepniGo is a digital platform designed to modernize traditional jeepney transport in the Philippines. We bridge drivers, operators, and commuters through technology—offering booking, GPS tracking, and digital fare collection.
                        </p>
                        <p class="text-white mb-4" style="font-size: 1.05rem; line-height: 1.8; opacity: 0.9;">
                            Our goal is to make public transportation more reliable, inclusive, and efficient for everyone. Whether you're a daily commuter, a dedicated driver, or a cooperative operator, JeepniGo empowers you with tools for a better journey.
                        </p>
                        ...
                        <div class="about-features mt-4">
                            <div class="d-flex align-items-start mb-3">
                                ...
                                <div>
                                    <h5 class="text-white fw-bold mb-1">Reliable & Safe</h5>
                                    <p class="text-white mb-0" style="opacity: 0.9; font-size: 0.95rem;">Track your ride in real-time and feel secure throughout your journey.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start mb-3">
                                <div style="
                                ...
                                <div>
                                    <h5 class="text-white fw-bold mb-1">Community Focused</h5>
                                    <p class="text-white mb-0" style="opacity: 0.9; font-size: 0.95rem;">Supporting local drivers and cooperatives with modern technology.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h5 class="text-white fw-bold mb-1">Future Ready</h5>
                                    <p class="text-white mb-0" style="opacity: 0.9; font-size: 0.95rem;">Embracing innovation for a sustainable transport system.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row text-center mb-5 animate__animated animate__fadeIn">
                <div class="col-lg-8 mx-auto">
                    ...
                    <h2 class="display-5 fw-bold mb-4" style="color: #1a202c;">What Our Users Say</h2>
                    <p class="lead" style="color: #718096;">Hear from our satisfied commuters and drivers about their experience with JeepniGo.</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
