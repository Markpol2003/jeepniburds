...
.stat-card:hover {
    ...
    box-shadow: 0 25px 30px -10px rgba(0, 0, 0, 0.1), 0 15px 15px -5px rgba(0, 0, 0, 0.04);
...
.stat-number {
    ...
    background: linear-gradient(45deg, #000, #3b82f6);
...
/* Add subtle pulse animation to stat numbers */
