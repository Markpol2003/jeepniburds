...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign_jeepney'])) {
    ...
    try {
        ...
        $insert_assignment = $conn->prepare("INSERT INTO jeepney_assignments (driver_id, plate_number, body_number, route, notes) VALUES (?, ?, ?, ?, ?)");
        $insert_assignment->bind_param("issss", $driver_id, $plate_number, $body_number, $route, $notes);
