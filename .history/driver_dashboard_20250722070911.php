        ...
        <?php if ($page === 'pay_boundary'): ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="alert alert-secondary" style="font-size: 0.95em;">
                                <strong>Debug Info:</strong><br>
                                <b>operator_id:</b> <span id="debugOperatorId"><?= htmlspecialchars($assignedJeepney['operator_id'] ?? 'N/A') ?></span><br>
                                <b>jeepney_id:</b> <span id="debugJeepneyId"><?= htmlspecialchars($assignedJeepney['id'] ?? 'N/A') ?></span><br>
                                <b>Assignment:</b> <pre style="white-space: pre-wrap; word-break: break-all; background: #f8f9fa; padding: 5px; border-radius: 4px;"><?= htmlspecialchars(json_encode($assignedJeepney, JSON_PRETTY_PRINT)) ?></pre>
                            </div>
            ...
            <?php else: ?>
                <div class="alert alert-danger mt-4">
                    <strong>Error:</strong> You are not assigned to any jeepney or operator. Please contact your operator before paying boundary.<br>
                    <small class="text-danger">Debug: No active assignment found for this driver.</small>
                </div>
            <?php endif; ?>
        <?php endif; ?>
