            ...
            $('#paymentsTable').DataTable({
                ...
                columns: [
                    { data: null, render: function(data, type, row) {
                        return '<div class="text-sm font-medium text-gray-900">' + row.firstName + ' ' + row.lastName + '</div>';
                    }},
                    ...
                    { data: 'amount', render: function(data, type, row) {
                        return '<div class="text-sm text-gray-900">₱' + parseFloat(data).toFixed(2) + '</div>';
                    }},
                    { data: 'method', render: function(data, type, row) {
                        const isGCash = data === 'gcash';
                    ...
                    { data: 'payment_date', render: function(data, type, row) {
                        return '<div class="text-sm text-gray-500">' + new Date(data).toLocaleString('en-US', {
                            month: 'short',
                            day: 'numeric',
                            year: 'numeric',
                            hour: 'numeric',
