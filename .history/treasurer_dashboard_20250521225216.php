...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment'])) {
    ...
    try {
        ...
        $userQuery = "SELECT p.*, u.id as user_id, u.firstName, u.lastName, u.userType, u.email, u.phone 
        ...
        $insertReceiptStmt = $conn->prepare("
            INSERT INTO user_receipts (
                ...
                member_name, member_type, member_email, member_phone
            )
        ...
        $memberPhone = $paymentInfo['phone'] ?? '';
        
        $insertReceiptStmt->bind_param('iissssissis', 
            $paymentInfo['user_id'],
            $paymentId,
            $receiptNumber,
            $paymentInfo['amount'],
...
<head>
    ...
    <!-- Replace CDN with local Tailwind CSS -->
