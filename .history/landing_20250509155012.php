  ...
  <div class="container">
        ...
        <div class="container">
            <div class="row text-center mb-5 animate__animated animate__fadeIn">
                <div class="col-lg-8 mx-auto">
                    <span class="text-primary fw-semibold text-uppercase mb-3 d-block">Why Choose Us</span>
    ...
    <section id="testimonials" class="py-20 bg-white">
        <div class="container">
            <div class="row text-center mb-5 animate__animated animate__fadeIn">
                <div class="col-lg-8 mx-auto">
                    <span class="text-primary fw-semibold text-uppercase mb-3 d-block">Testimonials</span>
    ...
    <section id="contact" class="py-20 bg-gray-50">
        <div class="container">
            <div class="row text-center mb-5 animate__animated animate__fadeIn">
                <div class="col-lg-8 mx-auto">
                    <span class="text-primary fw-semibold text-uppercase mb-3 d-block">Contact Us</span>
...
<section id="about" class="py-20 bg-white">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="about-card animate__animated animate__fadeInLeft" style="animation-delay: 0.2s;">
            ...
            <div class="col-lg-4">
                <div class="about-card animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                    <div class="about-icon">
            ...
            <div class="col-lg-4">
                <div class="about-card animate__animated animate__fadeInRight" style="animation-delay: 0.6s;">
                    <div class="about-icon">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.feature-card, .testimonial-card, .contact-card, .section-header').forEach((el) => {
