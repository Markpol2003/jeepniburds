...
<?php endif; ?>
    ...
    .content.jeepney-status-page .location-header,
    .content.jeepney-status-page .header-content,
    .content.jeepney-status-page .map-card,
    .content.jeepney-status-page .status-section,
    .content.jeepney-status-page .status-card,
    .content.jeepney-status-page .card,
    .content.jeepney-status-page .alert {
