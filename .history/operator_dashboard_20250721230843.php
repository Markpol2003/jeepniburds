    ...
    function fetchBoundaries() {
        ...
        .then(data => {
            ...
            if (data.success && data.boundaries.length > 0) {
                // DEBUG: Show operator_id
                document.getElementById('boundariesTableContainer').insertAdjacentHTML('beforebegin',
                    `<div class="alert alert-info"><strong>DEBUG:</strong> Operator ID: ${operator_id}</div>`);
                // DEBUG: Show raw data
