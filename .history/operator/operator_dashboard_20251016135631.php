      ...
      <ul class="nav navbar-nav" style="margin: 0; padding: 10px 0;">
        ...
        <li class="<?= $page === 'collect_boundaries' ? 'active' : '' ?>">
          <a href="?page=collect_boundaries" style="color: white; padding: 14px 20px; display: flex; align-items: center; text-decoration: none; transition: all 0.3s ease;">
            ...
            <span style="font-size: 1rem; font-weight: 500;">Collect Boundaries</span>
          </a>
        </li>
        <li class="<?= $page === 'pay_cooperative' ? 'active' : '' ?>">
          <a href="?page=pay_cooperative" style="color: white; padding: 14px 20px; display: flex; align-items: center; text-decoration: none; transition: all 0.3s ease;">
            <i class="bi bi-bank2" style="font-size: 1.2rem; margin-right: 12px; width: 24px;"></i>
            <span style="font-size: 1rem; font-weight: 500;">Pay Cooperative Funds</span>
          </a>
        </li>
