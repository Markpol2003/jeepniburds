...
<body>
    ...
    <div class="d-flex">
        ...
        @media (max-width: 992px) {
            .content-wrapper { margin-left: 250px; width: calc(100% - 250px); padding-top: 60px !important; }
            .sidebar { min-width: 250px; }
        }
        @media (max-width: 768px) {
            .sidebar { transform: translateX(-100%); transition: transform 0.3s ease; }
            .sidebar.open { transform: translateX(0); }
            .content-wrapper { margin-left: 0; width: 100%; padding-top: 70px !important; position: relative; z-index: 1; }
