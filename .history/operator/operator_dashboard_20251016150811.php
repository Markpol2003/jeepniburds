...
<button class="sidebar-toggle" id="sidebarToggle" aria-label="Toggle sidebar">
    ...
    <div class="d-flex">
        ...
        .content-container { padding: 1.5rem; background: transparent; }
...
/* Ensure all content sections have transparent backgrounds */
.content > .container-fluid {
    background: transparent !important;
}

.content > div:not(.card),
.content > .row,
.content .container-fluid > .row {
    background: transparent !important;
}

/* Only cards should have white backgrounds */
.card {
...
/* Keep card bodies and their content with their intended backgrounds */
.card-body {
    background: inherit;
}

/* Allow nested bg-white elements inside cards to remain white */
.card .bg-white {
    background: #ffffff !important;
}

/* Maintain card header colors */
