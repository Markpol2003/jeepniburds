  ...
  <div class="container-fluid" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); margin: 0; padding: 0;">
    ...
    <div class="collapse navbar-collapse" id="myNavbar" style="background: rgba(0,0,0,0.15); max-height: 0; overflow: hidden; display: none;">
      <ul class="nav navbar-nav" style="margin: 0; padding: 10px 0;">
        ...
        <li class="<?= $page === 'collect_boundaries' ? 'active' : '' ?>">
          <a href="?page=collect_boundaries" style="color: white; padding: 14px 20px; display: flex; align-items: center; text-decoration: none; transition: all 0.3s ease;">
        ...
        <li class="<?= $page === 'pay_cooperative' ? 'active' : '' ?>">
          <a href="?page=pay_cooperative" style="color: white; padding: 14px 20px; display: flex; align-items: center; text-decoration: none; transition: all 0.3s ease;">
...
<button class="sidebar-toggle" id="sidebarToggle" aria-label="Toggle sidebar">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="d-flex align-items-center gap-3">
                    <img src="../img/logo12.png" alt="JeepniGo Logo">
            ...
            <div class="content-container">
                <div class="content <?= $page === 'dashboard' ? 'dashboard-page' : ($page === 'profile' ? 'profile-page' : ($page === 'payment' ? 'payment-page' : ($page === 'manage_jeepneys' ? 'manage-page' : ($page === 'assignjeepney' ? 'assign-page' : ($page === 'collect_boundaries' ? 'boundaries-page' : ($page === 'pay_cooperative' ? 'cooperative-page' : 'dashboard-page')))))); ?>">
    ...
    .invalid-feedback {
        font-size: 0.875em;
                ...
                function deleteJeepney(jeepneyId) {
                    ...
                    <?php elseif ($page === 'manage_jeepneys'): ?>
                        <!-- Manage Jeepneys Page -->
                        <div class="card shadow-sm">
                            <div class="card-header bg-info text-white">
                                <h5 class="mb-0">🚐 Manage Jeepneys</h5>
                            </div>
                            <div class="card-body">
                                <p class="text-muted">Jeepney management features coming soon...</p>
                            </div>
                        </div>
    ...
    <script>
    // Search functionality for assign jeepney page
    document.getElementById('searchDriver')?.addEventListener('keyup', function() {
        const searchValue = this.value.toLowerCase();
        const rows = document.querySelectorAll("#driversTable tbody tr");
    ...
    // Modal handling for assigning jeepney
    function openAssignModal(driverId, driverName, driverEmail) {
        document.getElementById('driverName').textContent = driverName;
        document.getElementById('driverEmail').textContent = driverEmail;
        document.getElementById('driverId').value = driverId;
        ...
        Swal.fire({
            ...
            html: `
                <form id="editAssignmentForm" class="text-start">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Body Number</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="route" class="form-control" value="${route}" required>
                    </div>
                </form>
            `,
            showCancelButton: true,
    ...
    function deleteAssignment(assignmentId, driverName) {
        Swal.fire({
            ...
            html: `Are you sure you want to delete the jeepney assignment for <strong>${driverName}</strong>?<br><small class="text-muted">This action cannot be undone.</small>`,
            icon: 'warning',
            showCancelButton: true,
            ...
            preConfirm: () => {
                ...
                return fetch('process_delete_jeepney.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => response.json())
    ...
    // Handle assign jeepney form submission
    document.getElementById('assignJeepneyForm')?.addEventListener('submit', function(e) {
        e.preventDefault();
    ...
    document.getElementById('plateNumber')?.addEventListener('change', function() {
        ...
        document.getElementById('route').value = route || '';
                    ...
                    <?php elseif ($page === 'collect_boundaries'): ?>
    ...
    if (data.success && data.boundaries.length > 0) {
        ...
        document.getElementById('boundariesTableContainer').innerHTML = debugHtml + document.getElementById('boundariesTableContainer').innerHTML;
                    ...
                    <?php elseif ($page === 'pay_cooperative'): ?>
                ...
                <div class="p-4 h-100 bg-white rounded-4 shadow-sm border position-relative" style="min-height: 420px;">
                    ...
                    <div class="mb-4">
                        ...
                        $instructions = [
                            'gcash' => [
                                'number' => '09123456789',
                                'name' => 'JeepniGo Cooperative'
                            ],
                            'bank' => [
                                'name' => 'BDO',
                                'account' => '1234567890',
                                'account_name' => 'JeepniGo Cooperative Fund'
                            ],
                            'office' => 'JeepniGo Office, Toril, Davao City'
                        ];
                        ?>
                        <div class="row g-2">
                            <div class="col-12">
...
<!-- Enhanced Styles for Operator Dashboard -->
<style>
/* Animations */
@keyframes fadeIn {
    from {
...
/* Content wrapper and container overrides - match passenger/driver dashboard */
.content-wrapper { 
...
/* Page containers - ALL transparent backgrounds */
.content.dashboard-page,
.content.profile-page,
.content.payment-page,
.content.manage-page,
.content.assign-page,
.content.boundaries-page,
...
/* Ensure all direct children of content are properly sized */
.content > * {
    width: 100%;
    max-width: 100%;
}
