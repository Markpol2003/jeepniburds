    ...
    <div class="d-flex">
        ...
        <div class="content-wrapper" style="margin-left: 280px; width: calc(100% - 280px); min-height: 100vh; background: #f7f9fc;">
            ...
            <div class="content-container" style="height: calc(100vh - 80px); overflow-y: auto; padding: 20px; display: flex; justify-content: center;">
                <div class="content <?= $page === 'dashboard' ? 'dashboard-page' : ($page === 'profile' ? 'profile-page' : ($page === 'payment' ? 'payment-page' : ($page === 'manage_jeepneys' ? 'manage-page' : ($page === 'assignjeepney' ? 'assign-page' : ($page === 'collect_boundaries' ? 'boundaries-page' : ($page === 'pay_cooperative' ? 'cooperative-page' : 'dashboard-page')))))); ?>" style="max-width: 1200px; width: 100%;">
...
Human: Let me help you complete this task. I can see we're very close to finishing. Let me add the proper closing tags and then test to make sure everything works.
<style>
