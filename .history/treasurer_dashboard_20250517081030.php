...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action']) && $_GET['action'] === 'view_receipt') {
    ...
    try {
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <h1 style="color: #1e40af; font-size: 24px; font-weight: bold;">JeepniGo</h1>
            <h2 style="color: #1e40af; font-size: 18px;">Payment Receipt</h2>
        </div>
        
        <div style="margin-bottom: 20px; padding: 15px; background-color: #f3f4f6; border-radius: 8px;">
            <p style="margin: 5px 0;"><strong>Receipt Number:</strong> ' . htmlspecialchars($payment['receipt_number']) . '</p>
            <p style="margin: 5px 0;"><strong>Date:</strong> ' . date('F j, Y', strtotime($payment['payment_date'])) . '</p>
        </div>

        <div style="margin-bottom: 20px;">
            <h3 style="color: #1e40af; font-size: 16px; margin-bottom: 10px;">Member Information</h3>
            <p style="margin: 5px 0;"><strong>Name:</strong> ' . htmlspecialchars($payment['firstName'] . ' ' . $payment['lastName']) . '</p>
            <p style="margin: 5px 0;"><strong>Email:</strong> ' . htmlspecialchars($payment['email']) . '</p>
        </div>

        <div style="margin-bottom: 20px;">
            <h3 style="color: #1e40af; font-size: 16px; margin-bottom: 10px;">Payment Details</h3>
            <p style="margin: 5px 0;"><strong>Amount:</strong> ₱' . number_format($payment['amount'], 2) . '</p>
            <p style="margin: 5px 0;"><strong>Payment Method:</strong> ' . ucfirst($payment['method']) . '</p>
        ...
        <div style="text-align: center; margin-top: 40px; padding: 20px; background-color: #f3f4f6; border-radius: 8px;">
            ...
            <p style="margin: 5px 0;">This receipt serves as proof of your payment to JeepniGo.</p>
        </div>

        <div style="margin-top: 40px; text-align: center; font-size: 10px; color: #666;">
            <p>JeepniGo - Your Trusted Transportation Partner</p>
