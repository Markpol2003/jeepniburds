...
<div class="d-flex">
    ...
    <div class="content-wrapper" style="margin-left: 280px; width: calc(100% - 280px); min-height: 100vh; background: #f7f9fc;">
        ...
        <div class="content-container" style="height: calc(100vh - 80px); overflow-y: auto; padding: 20px; display: flex; justify-content: center;">
            <div class="content <?= $page === 'dashboard' ? 'dashboard-page' : ($page === 'collect_fares' ? 'fares-page' : ($page === 'profile' ? 'profile-page' : ($page === 'payment' ? 'payment-page' : ($page === 'assignjeepney' ? 'assignment-page' : ($page === 'pay_boundary' ? 'boundary-page' : ($page === 'boarding_dashboard' ? 'boarding-page' : 'dashboard-page')))))); ?>" style="max-width: 1200px; width: 100%;">
