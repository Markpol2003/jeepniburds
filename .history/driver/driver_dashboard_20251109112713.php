                        ...
                        .then(r=>r.json()).then(async d=>{
                            ...
                            if(d && d.success){
                                ...
                                try {
                                    ...
                                    const visibilityPercentNum = visibilityPercent !== 'N/A' ? parseFloat(visibilityPercent) : 0;
                                    const visibilityClass = visibilityPercent === 'N/A' ? 'text-muted' :
                                                           visibilityPercentNum >= 80 ? 'text-success' : 
                                                           visibilityPercentNum >= 50 ? 'text-warning' : 'text-danger';
                ...
                function vmLoadAll(){
                    ...
                    Promise.all(promises).then(results => {
                        ...
                        const rows = results.map(r => {
                            ...
                            // If app boardings > total trips (data inconsistency), still cap at 100%
                            ...
                            const visibilityPercentNum = parseFloat(visibilityPercent);
                            const visibilityClass = visibilityPercentNum >= 80 ? 'text-success' : 
                                                   visibilityPercentNum >= 50 ? 'text-warning' : 'text-danger';
