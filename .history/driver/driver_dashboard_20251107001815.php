                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover mb-0" style="border-radius: 0;">
                            <thead class="table-light" style="border-radius: 0;">
                                <tr>
                                    <th style="border-top-left-radius: 0; border-top-right-radius: 0;">Time Slot</th><th>Plate</th><th>Route</th>
                                    <th class="text-end">Total App Trips</th><th class="text-end">Collected</th><th class="text-end" style="border-top-right-radius: 0;">Rate %</th>
                                </tr>
                            </thead>
