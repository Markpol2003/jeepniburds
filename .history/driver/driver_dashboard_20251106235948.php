...
<div class="d-flex">
    ...
    <div class="content-wrapper">
        ...
        <?php elseif ($page === 'collect_fares'): ?>
            ...
            <!-- Fare Compliance (App-based, simple) -->
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-dark text-white"><i class="bi bi-clipboard-data"></i> Fare Compliance (App)</div>
                <div class="card-body">
                    <div class="row g-2">
                        <div class="col-md-3">
                    ...
                    <div class="row g-2">
                        <div class="col-md-3">
                            <label class="form-label small">Total App Trips</label>
                            <input type="text" class="form-control form-control-sm" id="fcTotal" value="0" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small">Collected (Paid)</label>
                            <input type="text" class="form-control form-control-sm" id="fcCompliant" value="0" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small">Compliance Rate (%)</label>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-secondary text-white"><i class="bi bi-table"></i> Compliance by Time Slot (Today)</div>
                <div class="card-body p-0">
            ...
            (function(){
                ...
                function fcRender(total, compliant){
                    ...
                    document.getElementById('fcRate').value = rate.toFixed(1)+'%';
                }
                function fcCompute(){
                    ...
                    .then(r=>r.json()).then(d=>{
                        ...
                        fcRender(total, compliant);
                    });
                }
                function fcLoadSlots(){
                    const plate = document.getElementById('fcPlate').value;
                    const route = document.getElementById('fcRoute').value;
                    ...
                    Promise.all(slots.map(s=>{
                        ...
                        const html = rows.map(r=>{
                            ...
                            return `<tr>
                                <td>${r.slot.label}</td><td>${plate||'-'}</td><td>${route||'-'}</td>
                ...
                document.getElementById('fcDate').addEventListener('change', fcLoadSlots);
                document.addEventListener('DOMContentLoaded', fcLoadSlots);
            })();
            </script>
            <?php else: ?>
