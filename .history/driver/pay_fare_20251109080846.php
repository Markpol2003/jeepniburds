...
if ($action === 'count') {
    ...
    // Route format might be "Origin → Destination", "Origin - Destination", or "Origin  Destination"
    $routeParts = preg_split('/[→\->]|\s{2,}/', $route, 2); // Split on arrow, dash, or multiple spaces
    if (count($routeParts) < 2) {
        // Try splitting on single space if no separator found
