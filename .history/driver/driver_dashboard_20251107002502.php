            ...
            <div class="row g-3 mt-3">
                <div class="col-12">
                    <div class="card shadow-sm" style="border-radius: 0;">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center" style="border-radius: 0; border-bottom: none;">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover mb-0" style="border-radius: 0;">
                                    <thead class="table-light" style="border-radius: 0;">
                                        <tr>
                                            <th style="border-top-left-radius: 0; border-top-right-radius: 0;">Time Period</th>
                                            <th>Plate Number</th>
                                            <th>Route</th>
                                            <th class="text-end" style="border-top-right-radius: 0;">App Boarding Count</th>
                                        </tr>
                                    </thead>
                                    <tbody id="vmRows">
                                        <tr>
                        ...
                        <div class="card-footer bg-light" style="border-radius: 0;">
                            <div class="d-flex justify-content-between align-items-center">
