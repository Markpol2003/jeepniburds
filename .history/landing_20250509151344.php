    ...
    ">
        <div class="container" style="max-width: 1200px; padding: 0 2rem;">
            <a class="navbar-brand d-flex align-items-center" href="#">
                ...
                <span style="font-size: 1.5rem; font-weight: 600; color: #2c3e50;">JeepniGo</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item mx-2">
                        <a class="nav-link fw-medium" href="#features" style="color: #2c3e50; transition: color 0.3s ease;">Features</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link fw-medium" href="#about" style="color: #2c3e50; transition: color 0.3s ease;">About</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link fw-medium" href="#contact" style="color: #2c3e50; transition: color 0.3s ease;">Contact</a>
                    </li>
                    <li class="nav-item ms-3">
                        <a class="btn btn-primary px-4 py-2 rounded-pill fw-medium" 
                           href="#" 
