...
<div class="col-md-6 mb-4">
    <div class="card shadow-sm">
        ...
        <?php if ($page === 'pay_boundary'): ?>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">No Jeepney Assigned</h5>
                </div>
                <div class="card-body text-center">
                    <p>You need to be assigned a jeepney before you can pay boundaries.</p>
                    <p>Driver ID: <?= $userId ?></p>
                    <p>Assigned Jeepney: <?= $assignedJeepney ? 'Yes' : 'No' ?></p>
                </div>
            </div>
            <?php endif; ?>
    </div>
