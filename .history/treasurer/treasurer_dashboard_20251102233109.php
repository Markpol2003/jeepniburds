    ...
    <div class="flex h-screen">
        ...
        <nav class="w-64 bg-gradient-to-b from-blue-600 to-blue-800 text-white p-6 shadow-xl transform transition-transform duration-300 hover:translate-x-0">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="#" onclick="openProfileModal(); return false;" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white/20 transition-all duration-200">
                ...
                <form id="profileUpdateForm" enctype="multipart/form-data">
                    <div class="mb-4">
                        <label for="profile_image" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="bi bi-camera-fill mr-1"></i>Upload Profile Picture
                        </label>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                               name="firstName" id="firstName" value="<?= htmlspecialchars($userFirstName); ?>" required>
                    </div>
                    <div class="mb-4">
                        <label for="middleName" class="block text-sm font-medium text-gray-700 mb-2">Middle Name</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                               name="middleName" id="middleName" value="<?= htmlspecialchars($_SESSION['user_middleName'] ?? ''); ?>">
                    </div>
                    <div class="mb-4">
                        <label for="lastName" class="block text-sm font-medium text-gray-700 mb-2">Last Name</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                               name="lastName" id="lastName" value="<?= htmlspecialchars($userLastName); ?>" required>
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                               name="email" id="email" value="<?= htmlspecialchars($_SESSION['user_email'] ?? ''); ?>" required>
                    </div>
