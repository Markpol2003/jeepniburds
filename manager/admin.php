...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <?php elseif ($section === 'performance'): ?>
      <div class="mb-6">
        ...
        <p class="text-slate-600 mt-1">Monitor waiting times and system efficiency</p>
      </div>
      
      <!-- Current Metrics -->
      <div class="bg-white rounded-2xl border p-5 shadow mb-6">
        <h3 class="text-xl font-semibold text-slate-800 mb-4">Current System Metrics (Today)</h3>
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div class="p-4 rounded-lg bg-slate-50">
            <div class="text-slate-500 text-sm">Arrival Rate (λ)</div>
            <div class="text-2xl font-bold text-indigo-600 mt-1"><?= $todayMetrics['lambda'] ?? 0 ?></div>
          </div>
          <div class="p-4 rounded-lg bg-slate-50">
            <div class="text-slate-500 text-sm">Service Rate (μ)</div>
            <div class="text-2xl font-bold text-indigo-600 mt-1"><?= $todayMetrics['mu'] ?? 0 ?></div>
          </div>
          <div class="p-4 rounded-lg bg-slate-50">
            <div class="text-slate-500 text-sm">Utilization (ρ)</div>
            <div class="text-2xl font-bold text-indigo-600 mt-1"><?= $todayMetrics['rho'] ?? 0 ?>%</div>
          </div>
          <div class="p-4 rounded-lg bg-slate-50">
            <div class="text-slate-500 text-sm">Avg Wait Time</div>
            <div class="text-2xl font-bold text-indigo-600 mt-1"><?= $todayMetrics['wq'] ?? 0 ?> min</div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl border p-5 shadow">
        <h3 class="text-xl font-semibold text-slate-800 mb-4">Waiting Time: With vs Without JeepniGo</h3>
        <div class="overflow-x-auto">
          <table class="min-w-full text-left text-sm">
            <thead class="bg-slate-100 text-slate-700 font-semibold">
              <tr>
                <th class="px-4 py-3">Traffic Condition</th>
                <th class="px-4 py-3 text-end">Without JeepniGo</th>
                <th class="px-4 py-3 text-end">With JeepniGo</th>
            ...
            <tbody class="divide-y divide-slate-100">
              ...
              ?>
              <tr>
                <td class="px-4 py-3 font-medium"><?= $scenario ?></td>
                <td class="px-4 py-3 text-end text-red-600 font-semibold"><?= $without ?> mins</td>
                <td class="px-4 py-3 text-end text-green-600 font-semibold"><?= $with ?> mins</td>
        ...
        <div class="mt-4 p-3 bg-blue-50 rounded-lg">
          <div class="text-sm text-blue-800">
            <i class="bi bi-info-circle"></i> Data based on last 30 days. Shows how JeepniGo reduces waiting times across different traffic conditions.
          </div>
        </div>
      </div>
    <?php endif; ?>
