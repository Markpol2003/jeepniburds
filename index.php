...
<body>
    ...
    <section id="features" class="section-light">
        <div class="container">
            <div class="text-center mb-5">
                <span class="glass-pill-badge mb-3">KEY FEATURES</span>
                <h2 class="display-6 fw-bold text-dark mb-3">Why Commuters & Operators Choose JeepniGo</h2>
                <p class="lead text-muted mx-auto" style="max-width: 650px;">Designed to modernize traditional jeepneys with comfortable booking, real-time safety, and smart fleet management.</p>
            </div>
    ...
    <section id="about" class="section-light" style="background: linear-gradient(180deg, rgba(224, 231, 255, 0.4) 0%, rgba(248, 250, 252, 0.8) 100%);">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <span class="glass-pill-badge mb-3">ABOUT JEEPNIGO</span>
                    <h2 class="display-6 fw-bold text-dark mb-4">Connecting Communities Through Smarter Commuting</h2>
    ...
    <section id="testimonials" class="section-light">
        <div class="container">
            <div class="text-center mb-5">
                <span class="glass-pill-badge mb-3">TESTIMONIALS</span>
                <h2 class="display-6 fw-bold text-dark mb-3">Loved by Commuters & Drivers</h2>
                <p class="lead text-muted mx-auto" style="max-width: 600px;">See how JeepniGo makes daily travel smoother and more enjoyable.</p>
            </div>
